...
void CudnnNdConvolutionIVSLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void CudnnNdConvolutionIVSLayer<Dtype>::Reshape(
  const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void CudnnNdConvolutionIVSLayer<Dtype>::compute_output_shape() {
  output_shape_.clear();
...
template <typename Dtype>
void CudnnNdConvolutionIVSLayer<Dtype>::Forward_cpu(
...
template <typename Dtype>
void CudnnNdConvolutionIVSLayer<Dtype>::Backward_cpu(
  const vector<Blob<Dtype>* >&
...
template <typename Dtype>
CudnnNdConvolutionIVSLayer<Dtype>::~CudnnNdConvolutionIVSLayer() {
...
INSTANTIATE_CLASS(CudnnNdConvolutionIVSLayer);
