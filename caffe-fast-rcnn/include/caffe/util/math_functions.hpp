...
template <typename Dtype>
void caffe_gpu_set_conv(const int N, const int M, const Dtype *Xa, Dtype *Y);

template <typename Dtype>
void caffe_gpu_find_max(const int N, const Dtype *X, Dtype* max);
...
template <typename Dtype>
void caffe_gpu_fc_mul(const int N, const int M, const Dtype* a, 
    const Dtype* b, Dtype* y, const int tran);

template <typename Dtype>
void caffe_gpu_conv_add(const int N, const int M, const Dtype* x, Dtype* y);

template <typename Dtype>
void caffe_gpu_STE(const int N, const Dtype min, const Dtype max, const Dtype* x, Dtype* x_diff);

template <typename Dtype>
void caffe_gpu_STE_q_stat(const int N, const Dtype* x, Dtype* x_diff);

template <typename Dtype>
void IVS_gpu_analyze_q_stat(Dtype* IVS_top_q_stat_data, Dtype* top_data, Dtype min_add, Dtype max_add, Dtype min_mult, Dtype max_mult, int N, int M);

template <typename Dtype>
void IVS_gpu_analyze_set_thresh(const int N, Dtype* data, Dtype min, Dtype max);

template <typename Dtype>
void caffe_gpu_analyze_max(const int N, const Dtype* x, Dtype* y);

template <typename Dtype>
void caffe_gpu_analyze_min(const int N, const Dtype* x, Dtype* y);

template <typename Dtype>
void caffe_gpu_analyze_max_serial(const int N, const Dtype* x, Dtype* y);

template <typename Dtype>
void caffe_gpu_analyze_min_serial(const int N, const Dtype* x, Dtype* y);
...
template <typename dtype>
void caffe_gpu_conv_mul(const int n, const int m, const dtype* a, const dtype* b, dtype* y);
