...
net = caffe.Net("models/test_BAQ/deconv.prototxt", caffe.TEST)
net_ori = caffe.Net("models/test_BAQ/deconv_ori.prototxt", caffe.TEST)
...
print'deconv done net'
res = net_ori.forward(start="conv1", end="conv1")
print'deconv done net_ori'
