...
def parse_args():
    ...
    parser.add_argument('--def', dest='prototxt',
                        ...
                        default='./models/c3d_kai/overtake/train_test_quant.prototxt', type=str)
    parser.add_argument('--net', dest='caffemodel',
                        help='model to test',
                        default='./models/c3d_kai/overtake/kai_train_iter_20000.caffemodel', type=str)
