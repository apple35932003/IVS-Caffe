...
if __name__ == '__main__':
    ...
    if has_conv:
        ...
        while not_found:
            ...
            jobs = []
            net_proto = read_from_prototxt(args.prototxt_quantized)
            quantize_net_conv(net_proto, net_param_IL,  i, -2)
            quantize_net_deconv(net_proto, net_param_IL, i, -2)
            ...
            p1.start()
            net_proto = read_from_prototxt(args.prototxt_quantized)
            quantize_net_conv(net_proto, net_param_IL,  i+1, -2)
            quantize_net_deconv(net_proto, net_param_IL, i+1, -2)
    ...
    while not_found:
        ...
        p1.start()
        net_proto = read_from_prototxt(args.prototxt_quantized)
        quantize_net_output(net_proto, net_output_IL, net_input_IL, i+1, 0)
        write_to_prototxt(net_proto, './temp'+str(i+1)+'.prototxt')
    ...
    net_proto = read_from_prototxt(args.prototxt_quantized)
    quantize_net_conv(net_proto, net_param_IL, bw_conv, -2)
    quantize_net_deconv(net_proto, net_param_IL, bw_conv, -2)
    ...
    while not_found:
        ...
        jobs.append(p1)
        p1.start()
        net_proto_BAC = read_from_prototxt(args.prototxt_quantized)
    ...
    quantize_net_conv(net_proto_final, net_param_IL, bw_conv, -2)
    quantize_net_deconv(net_proto_final, net_param_IL, bw_conv, -2)
