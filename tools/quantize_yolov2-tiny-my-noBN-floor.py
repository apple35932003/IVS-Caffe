...
if __name__ == '__main__':
    ...
    if has_conv:
        ...
        while not_found:
            ...
            jobs = []
            net_proto = read_from_prototxt(args.prototxt_quantized)
            quantize_net_conv(net_proto, net_param_IL, net_bias_IL, i, i, convIL_reduction)
            ...
            p1.start()
            net_proto = read_from_prototxt(args.prototxt_quantized)
            quantize_net_conv(net_proto, net_param_IL, net_bias_IL, i+1, i+1, convIL_reduction)
